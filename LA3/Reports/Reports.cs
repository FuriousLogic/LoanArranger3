...
namespace LA3.Reports
{
    public class Reports
    {
        ...
        public string MonthAudit(DateTime selectedMonth)
        {
            ...
            try
            {
                pdfPath = ReportHelper.CreateDoc(ref document);
                document.Open();
        ...
        public string NotPaid(int weeks)
        {
            ...
            try
            {
                ...
                foreach (var result in results)
                {
                    ...
                    Account account = (from a in _db.Accounts where a.Id == result.Account_Id select a).FirstOrDefault();
        ...
        public string OwingByCollector()
        {
            ...
            try
            {
                ...
                foreach (Collector c in _db.Collectors.ToList())
                {
                    double owing = c.TotalAmountOwed;
                    int customers = c.CustomersWithAccountsCount;
